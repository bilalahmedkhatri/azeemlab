        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services/web-design" className="text-gray-300 hover:text-accent transition-colors">
                  Web Design
                </Link>
              </li>
              <li>
                <Link href="/services/branding" className="text-gray-300 hover:text-accent transition-colors">
                  Branding
                </Link>
              </li>
              <li>
                <Link href="/services/seo" className="text-gray-300 hover:text-accent transition-colors">
                  SEO & Marketing
                </Link>
              </li>
              <li>
